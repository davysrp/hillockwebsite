<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="name" type="text" id="name" value="{{ old('name', optional($dining)->name) }}"
...
<div class="form-group {{ $errors->has('short_desc') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <textarea class="form-control" name="short_desc" cols="50" rows="10" id="short_desc"
                  placeholder="Enter short desc here...">{{ old('short_desc', optional($dining)->short_desc) }}</textarea>
...
<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <textarea class="form-control" name="description" cols="50" rows="10"
                  id="description">{{ old('description', optional($dining)->description) }}</textarea>
...
<div class="form-group {{ $errors->has('meta_keyword') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="meta_keyword" type="text" id="meta_keyword"
               value="{{ old('meta_keyword', optional($dining)->meta_keyword) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <textarea class="form-control" name="meta_description" cols="50" rows="10" id="meta_description"
                  placeholder="Enter meta description here...">{{ old('meta_description', optional($dining)->meta_description) }}</textarea>
...
<div class="form-group {{ $errors->has('photo') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="photo" type="file" id="photo"
               value="{{ old('photo', optional($dining)->photo) }}" maxlength="255">
        {!! $errors->first('photo', '<p class="help-block">:message</p>') !!}
    </div>

    @if(isset($dining) )
        @if($dining->photo!=null)
            <div class="row mt-2">
                <div class="col-md-1">
                    <img src="{!! asset('image/package/'.$dining->photo) !!}" class="w-100">
                </div>
            </div>
        @endif
    @endif
...
<div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="price" type="text" id="price"
               value="{{ old('price', optional($dining)->price) }}" maxlength="255" placeholder="Enter price here...">
