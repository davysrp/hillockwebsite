...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <span class="pull-left">
            <h4 class="mt-5 mb-5">{{ isset($title) ? $title : 'Product Security' }}</h4>
        </span>
    ...
    <div class="panel-body">
        <dl class="dl-horizontal">
            <dt>Product</dt>
            <dd>{{ optional($productSecurity->product)->name }}</dd>
            <dt>Security</dt>
            <dd>{{ optional($productSecurity->security)->name }}</dd>
            <dt>Created At</dt>
            <dd>{{ $productSecurity->created_at }}</dd>
            <dt>Updated At</dt>
            <dd>{{ $productSecurity->updated_at }}</dd>
