...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Product Views</h4>
            </div>
        ...
        @if(count($productViews) == 0)
            <div class="panel-body text-center">
                <h4>No Product Views Available.</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($productViews as $productView)
                        <tr>
                            <td>{{ optional($productView->Product)->name }}</td>
                            <td>{{ optional($productView->View)->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('product_views.product_view.show', $productView->id ) }}" class="btn btn-info" title="Show Product View">
