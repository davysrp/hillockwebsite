...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Product Features</h4>
            </div>
        ...
        @if(count($productFeatures) == 0)
            <div class="panel-body text-center">
                <h4>No Product Features Available.</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($productFeatures as $productFeature)
                        <tr>
                            <td>{{ optional($productFeature->product)->name }}</td>
                            <td>{{ optional($productFeature->feature)->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('product_features.product_feature.show', $productFeature->id ) }}" class="btn btn-info" title="Show Product Feature">
