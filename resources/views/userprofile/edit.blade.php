...
@section('profile')
    ...
    @endif
    {!! Form::model($product,['route'=>['updateproperty',$product->id],'enctype'=>'multipart/form-data']) !!}
            ...
            <div class="row  mb-3 mt-3">
                ...
                <div class="col-md-2">
                    <div class="product-thumb" style="background: url({!! asset('image/product/'.$ph->photo) !!})">
                        <a href="{!! route('remove-photo',$ph->id) !!}" onclick="return confirm(&quot;Click Ok to delete photo .&quot;)" class="btn btn-sm btn-danger"><i class="far fa-trash-alt"></i></a>
                    </div>
