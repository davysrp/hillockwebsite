...
@section('profile')
    ...
    @endif
    {!! Form::open(['route'=>'saveProperty','enctype'=>'multipart/form-data']) !!}
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="tabs-2" role="tabpanel">
            ...
            <div class="form-group">
                ...
                {!! Form::select('district_id',[],null,['class'=>'form-control','placeholder'=>'ជ្រើសរើសខណ្ឌ/ស្រុក']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('commune_id','សង្កាត់/ឃុំ') !!}
                {!! Form::select('commune_id',[],null,['class'=>'form-control','placeholder'=>'ជ្រើសរើសសង្កាត់/ឃុំ']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('village_id','ភូមិ') !!}
                {!! Form::select('village_id',[],null,['class'=>'form-control','placeholder'=>'ជ្រើសរើសភូមិ']) !!}
            </div>
            <div class="form-group">
        ...
        <div class="tab-pane" id="tabs-3" role="tabpanel">
            ...
            @foreach($amenities as $item)
                <div class="form-check">
                    <input class="form-check-input" name="amenity[]" type="checkbox" value="{!! $item->id !!}" id="amenity{!! $item->id !!}">
            ...
            @foreach($features as $item)
                <div class="form-check">
                    <input class="form-check-input" name="feature[]" type="checkbox" value="{!! $item->id !!}" id="Feature{!! $item->id !!}">
            ...
            @foreach($security as $item)
                <div class="form-check">
                    <input class="form-check-input" name="security[]" type="checkbox" value="{!! $item->id !!}" id="Security{!! $item->id !!}">
            ...
            @foreach($views as $item)
                <div class="form-check">
                    <input class="form-check-input" name="view[]" type="checkbox" value="{!! $item->id !!}" id="View{!! $item->id !!}">
        ...
        <div class="tab-pane" id="tabs-4" role="tabpanel">
            ...
            <div class="form-group">
                {!! Form::label('photo_detail','រូបថតច្រើនទៀត') !!}
                {!! Form::file('photo_details[]',['class'=>'form-control','multiple'=>'multiple','placeholder'=>'']) !!}
{{--                <input required type="file" class="form-control" name="photo_detail[]" placeholder="address" multiple>--}}
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script src="https://cdn.tiny.cloud/1/8iqkayiehoxiq0m8olzu8ptzb1ltp0t6sc7o5f0z3xdqlsqq/tinymce/5/tinymce.min.js"
