                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{!! route('features.feature.destroy', $feature->id) !!}" accept-charset="UTF-8">
                                        ...
                                        <div class="btn-group btn-group-xs pull-right" role="group">
                                           {{-- <a href="{{ route('features.feature.show', $feature->id ) }}" class="btn btn-info" title="Show Feature">
                                                <span class="glyphicon glyphicon-open" aria-hidden="true"></span>
                                            </a>--}}
                                            <a href="{{ route('features.feature.edit', $feature->id ) }}" class="btn btn-primary btn-sm" title="Edit Feature">
                                                <span class="fa fa-edit" aria-hidden="true"></span>
                                            </a>

                                            <button type="submit" class="btn btn-danger btn-sm" title="Delete Feature" onclick="return confirm(&quot;Click Ok to delete Feature.&quot;)">
