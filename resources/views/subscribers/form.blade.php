...
<div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="type" type="text" id="type" value="{{ old('type', optional($user)->type) }}" maxlength="255" placeholder="Enter type here...">
...
<div class="form-group {{ $errors->has('phonenumber') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="phonenumber" type="number" id="phonenumber" value="{{ old('phonenumber', optional($user)->phonenumber) }}" min="-2147483648" max="2147483647" placeholder="Enter phonenumber here...">
