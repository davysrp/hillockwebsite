...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Spa Photos</h4>
            </div>
        ...
        @if(count($spaPhotos) == 0)
            <div class="panel-body text-center">
                <h4>No Spa Photos Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($spaPhotos as $spaPhoto)
                        <tr>
                            <td>{{ optional($spaPhoto->spa)->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('spa_photos.spa_photo.show', $spaPhoto->id ) }}" class="btn btn-info" title="Show Spa Photo">
