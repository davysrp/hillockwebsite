                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{!! route('spas.spa.destroy', $spa->id) !!}" accept-charset="UTF-8">
                                        ...
                                        <div class="btn-group btn-group-xs pull-right" role="group">
                                            ...
                                            <a href="{{ route('spas.spa.edit', $spa->id ) }}" class="btn btn-primary btn-sm" title="Edit Spa">
                                                <span class="fa fa-edit" aria-hidden="true"></span>
                                            </a>

                                            <button type="submit" class="btn btn-danger btn-sm" title="Delete Spa" onclick="return confirm(&quot;Click Ok to delete Spa.&quot;)">
