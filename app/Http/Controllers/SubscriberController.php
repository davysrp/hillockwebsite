...
class SubscriberController extends Controller
{
    ...
    {
        $users = User::where('type','subscriber')->paginate(25);
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('subscribers.subscriber.index')
    ...
    protected function getData(Request $request)
    {
        $rules = [
            ...
            'phonenumber' => 'nullable|numeric|min:-2147483648|max:2147483647',
        ];
